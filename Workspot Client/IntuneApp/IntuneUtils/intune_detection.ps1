...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Workspot Client-v114")
    ...
    $IntuneAppValues.Add("AppUninstallName","Workspot Client")
    $IntuneAppValues.Add("AppUninstallVersion","6")
    $IntuneAppValues.Add("AppUninstallProcess","WorkspotClient")
