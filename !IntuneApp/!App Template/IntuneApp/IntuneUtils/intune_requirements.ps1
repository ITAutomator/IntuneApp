...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName"            ,"<<IntuneAppName>>")
    $IntuneAppValues.Add("AppInstaller"       ,"<<IntuneAppInstaller>>")
    $IntuneAppValues.Add("AppInstallName"     ,"<<IntuneAppInstallName>>")
    $IntuneAppValues.Add("AppInstallArgs"     ,"<<IntuneAppInstallArgs>>")
    $IntuneAppValues.Add("AppUninstallName"   ,"<<IntuneAppUninstallName>>")
    $IntuneAppValues.Add("AppUninstallVersion","<<IntuneAppUninstallVersion>>")
    $IntuneAppValues.Add("AppUninstallProcess","<<IntuneAppUninstallProcess>>")
    $IntuneAppValues.Add("SystemOrUser"       ,"<<IntuneSystemOrUser>>")
    $IntuneAppValues.Add("Function"           ,"<<IntuneFunction>>")
    $IntuneAppValues.Add("LogFolder"          ,"<<IntuneLogFolder>>")
    $IntuneAppValues.Add("AppVar1"            ,"<<IntuneAppVar1>>")
    $IntuneAppValues.Add("AppVar2"            ,"<<IntuneAppVar2>>")
    $IntuneAppValues.Add("AppVar3"            ,"<<IntuneAppVar3>>")
    $IntuneAppValues.Add("AppVar4"            ,"<<IntuneAppVar4>>")
    $IntuneAppValues.Add("AppVar5"            ,"<<IntuneAppVar5>>")
