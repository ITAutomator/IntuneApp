...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Teams for Business-v129")
...
$customps1_injection_lines +=' '
$customps1_injection_lines +='#>'
$customps1_injection_lines +='$Path=[Environment]::GetFolderPath("ProgramFiles")'
$customps1_injection_lines +='$Filename="ms-teams.exe"'
$customps1_injection_lines +='WriteLog "Finding: $($Filename)"'
$customps1_injection_lines +='$Findfiles = Get-ChildItem -Path $Path -Filter $Filename -File -Recurse -Force -ErrorVariable FailedItems -ErrorAction SilentlyContinue'
$customps1_injection_lines +='#'
$customps1_injection_lines +='if ($Findfiles) {'
$customps1_injection_lines +='    $fnd_msg = "Found"'
$customps1_injection_lines +='    $bOK = $True'
$customps1_injection_lines +='    $Findfiles.FullName | WriteLog'
$customps1_injection_lines +='}'
