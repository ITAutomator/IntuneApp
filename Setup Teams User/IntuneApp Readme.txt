...
-------------------------------
Set up of Teams user settings
openAtLogin     open automatically at user login : true
openAsHidden    open in the background Hidden : true
runningOnClose  running on Taskbar : true
