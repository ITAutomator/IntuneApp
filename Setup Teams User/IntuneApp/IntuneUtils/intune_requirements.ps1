...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Setup Teams User-v200")
    $IntuneAppValues.Add("AppInstaller","ps1")
    $IntuneAppValues.Add("AppInstallName","SetupTeamsUser.ps1")
    $IntuneAppValues.Add("AppInstallArgs","ARGS:-mode auto")
    $IntuneAppValues.Add("AppUninstallName","")
    $IntuneAppValues.Add("AppUninstallVersion","100")
...
$customps1_injection_lines +='WriteLog will log text to the Intune log (c:\IntuneApps)'
