...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Fonts-v114")
...
$customps1_injection_lines +='WriteLog "AppVar1 is $($IntuneApp.AppVar1)" # Fonts to Add: Font1 Name, Font2 Name'
$customps1_injection_lines +='WriteLog "AppVar2 is $($IntuneApp.AppVar2)" # Fonts to Remove: Old Font1 Name, Old Font2 Name'
$customps1_injection_lines +='# create some empty arrays'
$customps1_injection_lines +='$FontsAdd = @()'
$customps1_injection_lines +='$FontsRmv = @()'
...
$customps1_injection_lines +='        $FontsAdd += ($Contents -split ",").trim(" ") # array-ify the contents'
...
$customps1_injection_lines +='    if ($Contents -ne '''') {'
$customps1_injection_lines +='        $FontsRmv += ($Contents -split ",").trim(" ") # array-ify the contents'
$customps1_injection_lines +='    } # has contents'
$customps1_injection_lines +='} # there''s a : char'
$customps1_injection_lines +='$fontFolder = "$([Environment]::GetFolderPath("Windows"))\Fonts"'
$customps1_injection_lines +='if (Test-Path $fontFolder)'
$customps1_injection_lines +='{ # Windows font folder exists'
$customps1_injection_lines +='    ForEach ($Font in $FontsAdd)'
$customps1_injection_lines +='    {'
$customps1_injection_lines +='        $FontPath = "$($fontFolder)\$($Font)"'
$customps1_injection_lines +='        if (-not (Test-Path $FontPath))'
$customps1_injection_lines +='        {'
$customps1_injection_lines +='            WriteLog "Not Found: $($FontPath)"'
$customps1_injection_lines +='            $app_detected = $false'
$customps1_injection_lines +='            break'
$customps1_injection_lines +='        }'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='    ForEach ($Font in $FontsRmv)'
$customps1_injection_lines +='    {'
$customps1_injection_lines +='        $FontPath = "$($fontFolder)\$($Font)"'
$customps1_injection_lines +='        if (Test-Path $FontPath)'
$customps1_injection_lines +='        {'
$customps1_injection_lines +='            WriteLog "Found (should not be there): $($FontPath)"'
$customps1_injection_lines +='            $app_detected = $false'
$customps1_injection_lines +='            break'
$customps1_injection_lines +='        }'
$customps1_injection_lines +='    }'
