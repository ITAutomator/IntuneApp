...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Wifi-v115")
...
##########################################################
$customps1_injection_lines +='######################'
$customps1_injection_lines +='### Functions'
$customps1_injection_lines +='######################'
$customps1_injection_lines +='function WifiAddRemove {  '
$customps1_injection_lines +='    param ('
$customps1_injection_lines +='        [ValidateSet("Add", "Remove","Detect")]'
$customps1_injection_lines +='        [string]$AddRemoveDetect = "Add"'
$customps1_injection_lines +='        ,[string]$WifiName = "<YourNetworkName>"'
$customps1_injection_lines +='        ,[string]$WifiPass = ""'
$customps1_injection_lines +='        ,[ValidateSet("Open", "WPA2", "")]'
$customps1_injection_lines +='        [string]$OpenOrWPA2 = "WPA2"'
$customps1_injection_lines +='        ,[switch]$ConnectAfterAdd = $false'
$customps1_injection_lines +='        ,[switch]$Verbose = $false'
$customps1_injection_lines +='    )'
$customps1_injection_lines +='    If ($WifiName -eq "<YourNetworkName>") {'
$customps1_injection_lines +='        Return "ERR: Usage is .\WifiAddRemove.ps1 -WifiName <YourNetworkName> -WifiPass <YourNetworkPassword> -AddRemoveDetect <Add|Remove> -OpenOrWPA2 <Open|WPA2>"'
$customps1_injection_lines +='        Exit'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='    if ($OpenOrWPA2 -eq "") { # OpenOrWPA2 is empty - default to WPA2 if password is provided'
$customps1_injection_lines +='        if ($WifiPass -eq "") {'
$customps1_injection_lines +='            $OpenOrWPA2 = "Open"'
$customps1_injection_lines +='        } # Open'
$customps1_injection_lines +='        else {'
$customps1_injection_lines +='            $OpenOrWPA2 = "WPA2"'
$customps1_injection_lines +='        } # WPA2'
$customps1_injection_lines +='    } # OpenOrWPA2 is empty '
$customps1_injection_lines +=''
$customps1_injection_lines +='    if ($AddRemoveDetect -eq "Add")'
$customps1_injection_lines +='    { # Add'
$customps1_injection_lines +='        # Create a temporary XML profile'
$customps1_injection_lines +='        if ($OpenOrWPA2 -eq "Open")'
$customps1_injection_lines +='        { # Open network'
$customps1_injection_lines +='        #region XMLOpen'
$customps1_injection_lines +='        $profileXml = @"'
$customps1_injection_lines +='<?xml version="1.0"?>'
$customps1_injection_lines +='<WLANProfile xmlns="http://www.microsoft.com/networking/WLAN/profile/v1">'
$customps1_injection_lines +='    <name>$WifiName</name>'
$customps1_injection_lines +='    <SSIDConfig>'
$customps1_injection_lines +='        <SSID>'
$customps1_injection_lines +='            <name>$WifiName</name>'
$customps1_injection_lines +='        </SSID>'
$customps1_injection_lines +='    </SSIDConfig>'
$customps1_injection_lines +='    <connectionType>ESS</connectionType>'
$customps1_injection_lines +='    <connectionMode>manual</connectionMode>'
$customps1_injection_lines +='    <MSM>'
$customps1_injection_lines +='        <security>'
$customps1_injection_lines +='            <authEncryption>'
$customps1_injection_lines +='                <authentication>open</authentication>'
$customps1_injection_lines +='                <encryption>none</encryption>'
$customps1_injection_lines +='                <useOneX>false</useOneX>'
$customps1_injection_lines +='            </authEncryption>'
$customps1_injection_lines +='        </security>'
$customps1_injection_lines +='    </MSM>'
$customps1_injection_lines +='</WLANProfile>'
$customps1_injection_lines +='"@'
$customps1_injection_lines +='        #endregion XMLOpen'
$customps1_injection_lines +='        } # Open network'
$customps1_injection_lines +='        else '
$customps1_injection_lines +='        { # WPA2-secured network'
$customps1_injection_lines +='        #region XMLWPA2'
$customps1_injection_lines +='        $profileXml = @"'
$customps1_injection_lines +='<?xml version="1.0"?>'
$customps1_injection_lines +='<WLANProfile xmlns="http://www.microsoft.com/networking/WLAN/profile/v1">'
$customps1_injection_lines +='    <name>$WifiName</name>'
...
$customps1_injection_lines +='        <security>'
$customps1_injection_lines +='            <authEncryption>'
$customps1_injection_lines +='                <authentication>WPA2PSK</authentication>'
$customps1_injection_lines +='                <encryption>AES</encryption>'
$customps1_injection_lines +='                <useOneX>false</useOneX>'
$customps1_injection_lines +='            </authEncryption>'
$customps1_injection_lines +='            <sharedKey>'
$customps1_injection_lines +='                <keyType>passPhrase</keyType>'
$customps1_injection_lines +='                <protected>false</protected>'
$customps1_injection_lines +='                <keyMaterial>$WifiPass</keyMaterial>'
$customps1_injection_lines +='            </sharedKey>'
$customps1_injection_lines +='        </security>'
$customps1_injection_lines +='    </MSM>'
$customps1_injection_lines +='</WLANProfile>'
$customps1_injection_lines +='"@'
$customps1_injection_lines +='        #endregion XMLWPA2'
$customps1_injection_lines +='        } # WPA2-secured network'
$customps1_injection_lines +='        if (($OpenOrWPA2 -eq "WPA2") -and ($WifiPass.Length -lt 8))'
$customps1_injection_lines +='        { # password too short'
$customps1_injection_lines +='            $strReturn = "Err: [$($WifiName)] Password length ($($WifiPass.Length)) must be at least (8) [$($OpenOrWPA2)]"'
$customps1_injection_lines +='        } # password too short'
$customps1_injection_lines +='        Else'
$customps1_injection_lines +='        { # password length ok'
$customps1_injection_lines +='            $tempXmlPath = "$env:TEMP\wifi_profile_$($WifiName).xml"'
$customps1_injection_lines +='            $profileXml | Out-File -Encoding ASCII -FilePath $tempXmlPath'
$customps1_injection_lines +='            # Add the Wi-Fi profile'
$customps1_injection_lines +='            $sResult = netsh wlan add profile filename="$tempXmlPath" user=current'
$customps1_injection_lines +='            if ($sResult -and $Verbose) {WriteLog $sResult -ForegroundColor Blue}'
$customps1_injection_lines +='            if ($ConnectAfterAdd) {'
$customps1_injection_lines +='                # Connect to the network'
$customps1_injection_lines +='                $sResult = netsh wlan connect name="$WifiName"'
$customps1_injection_lines +='                if ($sResult -and $Verbose) {WriteLog $sResult -ForegroundColor Blue}'
$customps1_injection_lines +='            } # ConnectAfterAdd'
$customps1_injection_lines +='            # Clean up the temp file'
$customps1_injection_lines +='            Remove-Item -Path $tempXmlPath -Force | Out-Null'
$customps1_injection_lines +='            # Return success message'
$customps1_injection_lines +='            $strReturn = "OK: [$($WifiName)] Added [$($OpenOrWPA2) $($WifiPass)]"'
$customps1_injection_lines +='        } # password length ok'
$customps1_injection_lines +='    } # Add'
$customps1_injection_lines +='    elseif ($AddRemoveDetect -eq "Remove")'
$customps1_injection_lines +='    { # Remove '
$customps1_injection_lines +='        $sResult = netsh wlan delete profile name="$WifiName"'
$customps1_injection_lines +='        if ($sResult -and $Verbose) {WriteLog $sResult -ForegroundColor Blue}'
$customps1_injection_lines +='        # Return success message'
$customps1_injection_lines +='        $strReturn = "OK: [$($WifiName)] Removed"'
$customps1_injection_lines +='    } # Remove '
$customps1_injection_lines +='    elseif ($AddRemoveDetect -eq "Detect")'
$customps1_injection_lines +='    { # Detect '
$customps1_injection_lines +='        # List all Wi-Fi profiles'
$customps1_injection_lines +='        # Grab any User Profile line'
$customps1_injection_lines +='        $profiles = netsh wlan show profiles |'
$customps1_injection_lines +='            Select-String "User Profile\s*:\s*(.+)$" |'
$customps1_injection_lines +='            ForEach-Object { $_.Matches[0].Groups[1].Value.Trim() }'
$customps1_injection_lines +='        if (-not ($profiles -contains $WifiName)) {'
$customps1_injection_lines +='            $strReturn = "ERR: [$($WifiName)] not found"'
$customps1_injection_lines +='        } # profile not found'
$customps1_injection_lines +='        else'
$customps1_injection_lines +='        { # profile found'
$customps1_injection_lines +='            $strReturn = "OK: [$($WifiName) found]"'
$customps1_injection_lines +='            <# '
$customps1_injection_lines +='            $profileInfo = netsh wlan show profile name="$WifiName" key=clear'
$customps1_injection_lines +='            # Extract the Key Content line'
$customps1_injection_lines +='            $keyLine = $profileInfo | Select-String "Key Content\s*:\s*(.+)$"'
$customps1_injection_lines +='            if (($OpenOrWPA2 -eq "WPA2") -and (-not $keyLine)) {'
$customps1_injection_lines +='                $strReturn = "ERR: [$($WifiName) found but has no password]"'
$customps1_injection_lines +='            } # no key line'
$customps1_injection_lines +='            if ($keyLine) {'
$customps1_injection_lines +='                if ($OpenOrWPA2 -eq "Open") {'
$customps1_injection_lines +='                    $strReturn = "ERR: [$($WifiName) found but has a password]"'
$customps1_injection_lines +='                } # Open'
$customps1_injection_lines +='                else { # WPA2'
$customps1_injection_lines +='                    $storedKey = $keyLine.Matches[0].Groups[1].Value.Trim()'
$customps1_injection_lines +='                    if ($storedKey -eq $WifiPass) {'
$customps1_injection_lines +='                        $strReturn = "OK: [$($WifiName) found and password matches]"'
$customps1_injection_lines +='                    } # password matches'
$customps1_injection_lines +='                    else {'
$customps1_injection_lines +='                        $strReturn = "ERR: [$($WifiName) found but password doesn''t match]"'
$customps1_injection_lines +='                    } # password doesn''t match'
$customps1_injection_lines +='                } # WPA2'
$customps1_injection_lines +='            } # key line'
$customps1_injection_lines +='            else'
$customps1_injection_lines +='            { # no key line'
$customps1_injection_lines +='                if ($OpenOrWPA2 -eq "WPA2") {'
$customps1_injection_lines +='                    $strReturn = "ERR: [$($WifiName) found but has no password]"'
$customps1_injection_lines +='                } # WPA2'
$customps1_injection_lines +='                else {'
$customps1_injection_lines +='                    $strReturn = "OK: [$($WifiName) found with no password]"'
$customps1_injection_lines +='                } # Open'
$customps1_injection_lines +='            } # no key line'
$customps1_injection_lines +='            #>'
$customps1_injection_lines +='        } # profile found'
$customps1_injection_lines +='    } # Detect  '
$customps1_injection_lines +='    Return $strReturn'
$customps1_injection_lines +='}'
...
$customps1_injection_lines +=' '
$customps1_injection_lines +='#>'
$customps1_injection_lines +='$app_detected = $true # assume installed unless there''s a problem'
$customps1_injection_lines +=''
$customps1_injection_lines +='WriteLog "------ intune_settings.csv"'
$customps1_injection_lines +='WriteLog "AppVar1 is $($IntuneApp.AppVar1)" # Wifis to Add: Wifi1 Name, Wifi2 Name'
$customps1_injection_lines +='WriteLog "AppVar2 is $($IntuneApp.AppVar2)" # Wifis to Remove: Old Wifi1 Name, Old Wifi2 Name'
$customps1_injection_lines +='# create some empty arrays'
$customps1_injection_lines +='$WifisAdd = @()'
$customps1_injection_lines +='$WifisRmv = @()'
...
$customps1_injection_lines +='        $WifisAdd += ($Contents -split ",").trim(" ") # array-ify the contents'
$customps1_injection_lines +='    } # has contents'
$customps1_injection_lines +='} # there''s a : char'
$customps1_injection_lines +='if ($IntuneApp.AppVar2 -match ":") {'
$customps1_injection_lines +='    $Contents = ($IntuneApp.AppVar2 -split ":")[1].trim(" ") # grab the stuff after the :'
$customps1_injection_lines +='    if ($Contents -ne '''') {'
$customps1_injection_lines +='        $WifisRmv += ($Contents -split ",").trim(" ") # array-ify the contents'
$customps1_injection_lines +='    } # has contents'
$customps1_injection_lines +='} # there''s a : char'
$customps1_injection_lines +='ForEach ($Wifi in $WifisAdd)'
$customps1_injection_lines +='{'
$customps1_injection_lines +='    '
$customps1_injection_lines +='    $result = WifiAddRemove -AddRemoveDetect "Detect" -WifiName $wifi'
$customps1_injection_lines +='    $bDetected = $result.StartsWith("OK")'
$customps1_injection_lines +='    if (-not $bDetected)'
$customps1_injection_lines +='    {'
$customps1_injection_lines +='        WriteLog "Wifi Not Found: [$($wifi)] that should be added"'
$customps1_injection_lines +='        $app_detected = $false'
$customps1_injection_lines +='        break'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='}'
$customps1_injection_lines +='ForEach ($Wifi in $WifisRmv)'
$customps1_injection_lines +='{'
$customps1_injection_lines +='    $result = WifiAddRemove -AddRemoveDetect "Detect" -WifiName $wifi'
$customps1_injection_lines +='    $bDetected = $result.StartsWith("OK")'
$customps1_injection_lines +='    if ($bDetected)'
$customps1_injection_lines +='    {'
$customps1_injection_lines +='        WriteLog "Wifi Found: [$($wifi)] that should be removed"'
$customps1_injection_lines +='        $app_detected = $false'
$customps1_injection_lines +='        break'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='}'
