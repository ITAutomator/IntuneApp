...
-------------------------------
This App Installs Wifi signals according to WifisToManage.csv

To set up the CSV file launch WifiManager.cmd (or the .ps1) and edit as follows

AddRemoveDetect,WifiName,WifiPass,OpenOrWPA2
Add,MyNewWifiSignal,MyNewWifiPass,WPA2
Remove,MyOldWifiSignal,,

Then use the menu choice [S] to set up the package for the IntuneApps system.

-------------- WifisToManage.csv ------------------
 1 MyNewWifiSignal [Add]
 2 MyOldWifiSignal [Remove]
--------------- wifi Manager Menu ------------------
[I] to install managed wifis to this PC
[U] to uninstall managed wifis from this PC
[D] Detect if PC has wifis already
[S] Setup intune_settings.csv with these wifis (for IntuneApp)
...
-------------------------------
See below for more information about the IntuneApp project.
