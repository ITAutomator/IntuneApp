...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Dell Command Update UWP-v211")
    $IntuneAppValues.Add("AppInstaller","ps1")
    $IntuneAppValues.Add("AppInstallName","intune_install_customcode.ps1")
    $IntuneAppValues.Add("AppInstallArgs","ARGS:-mode auto")
    $IntuneAppValues.Add("AppUninstallName","")
    $IntuneAppValues.Add("AppUninstallVersion","4.8")
    $IntuneAppValues.Add("AppUninstallProcess","Dell Command*")
...
$customps1_injection_lines +=''
$customps1_injection_lines +='# $requirements_met is assumed true coming in to this script'
$customps1_injection_lines +='# Make sure this is a Dell computer'
$customps1_injection_lines +=''
$customps1_injection_lines +='WriteLog "requirements_met (before): $($requirements_met)"'
$customps1_injection_lines +='Function ComputerInfo'
$customps1_injection_lines +='{'
$customps1_injection_lines +='    ###############################################'
$customps1_injection_lines +='    $computerInfo = Get-ComputerInfo'
$customps1_injection_lines +='    $objProps = [ordered]@{ '
$customps1_injection_lines +='        Username              = $env:username'
$customps1_injection_lines +='        Userdomain            = $env:userdomain'
$customps1_injection_lines +='        CsName                = $computerInfo.CsName'
$customps1_injection_lines +='        CsUserName            = $computerInfo.CsUserName'
$customps1_injection_lines +='        LogonServer           = $computerInfo.LogonServer'
$customps1_injection_lines +='        BiosManufacturer      = $computerInfo.BiosManufacturer'
$customps1_injection_lines +='        BiosSeralNumber       = $computerInfo.BiosSeralNumber'
$customps1_injection_lines +='        CsManufacturer        = $computerInfo.CsManufacturer'
$customps1_injection_lines +='        CsModel               = $computerInfo.CsModel'
$customps1_injection_lines +='        PowerPlatformRole     = $computerInfo.PowerPlatformRole.ToString()'
$customps1_injection_lines +='        CsPCSystemType        = $computerInfo.CsPCSystemType.ToString()'
$customps1_injection_lines +='        WindowsProductName    = $computerInfo.WindowsProductName'
$customps1_injection_lines +='        } '
$customps1_injection_lines +='    $ComputerInfo = New-Object -TypeName psobject -Property $objProps '
$customps1_injection_lines +='    $ComputerInfo '
$customps1_injection_lines +='    ############################################### '
$customps1_injection_lines +='}'
$customps1_injection_lines +='$computerNeeded = "Dell Inc."'
$customps1_injection_lines +='$computerInfo = Get-computerInfo'
$customps1_injection_lines +='WriteLog "   CsManufacturer: $($computerInfo.CsManufacturer)"'
$customps1_injection_lines +='WriteLog "  BiosSeralNumber: $($computerInfo.BiosSeralNumber)"'
$customps1_injection_lines +='WriteLog "          CsModel: $($computerInfo.CsModel)"'
$customps1_injection_lines +='WriteLog "   CsPCSystemType: $($computerInfo.CsPCSystemType)"'
$customps1_injection_lines +='if ($computerInfo.CsManufacturer -eq $computerNeeded )'
$customps1_injection_lines +='{'
$customps1_injection_lines +='    WriteLog "OK: CsManufacturer is $($computerNeeded )"'
$customps1_injection_lines +='    $requirements_met=$true'
$customps1_injection_lines +='}'
$customps1_injection_lines +='else'
$customps1_injection_lines +='{'
$customps1_injection_lines +='    WriteLog "Requirements not met: CsManufacturer ''$($computerInfo.CsManufacturer)'' is not ''$($computerNeeded )''"'
