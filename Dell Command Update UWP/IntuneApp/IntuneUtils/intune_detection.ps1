...
$customps1_injection_lines +='$app_to_find     = "Dell Command*"'
$customps1_injection_lines +='#$app_ver_atleast = "24"'
$customps1_injection_lines +='$app_ver_atleast = $IntuneApp.AppUninstallVersion'
$customps1_injection_lines +='#'
$customps1_injection_lines +='$apps = WingetList'
$customps1_injection_lines +='$apps_c = $apps | Where-Object Name -like $app_to_find'
