...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Remove Local Admins-v213")
...
$customps1_injection_lines +=' '
$customps1_injection_lines +='#>'
$customps1_injection_lines +='## Show Local admins'
$customps1_injection_lines +=''
$customps1_injection_lines +='function Convert-AzureAdSidToObjectId {'
$customps1_injection_lines +='<#'
$customps1_injection_lines +='.SYNOPSIS'
$customps1_injection_lines +='Convert a Azure AD SID to Object ID'
$customps1_injection_lines +=' '
$customps1_injection_lines +='.DESCRIPTION'
$customps1_injection_lines +='Converts an Azure AD SID to Object ID.'
$customps1_injection_lines +='Author: Oliver Kieselbach (oliverkieselbach.com)'
$customps1_injection_lines +='The script is provided "AS IS" with no warranties.'
$customps1_injection_lines +=' '
$customps1_injection_lines +='.PARAMETER ObjectID'
$customps1_injection_lines +='The SID to convert'
$customps1_injection_lines +='#>'
$customps1_injection_lines +=''
$customps1_injection_lines +='    param([String] $Sid)'
$customps1_injection_lines +=''
$customps1_injection_lines +='    $text = $sid.Replace(''S-1-12-1-'', '''')'
$customps1_injection_lines +='    $array = [UInt32[]]$text.Split(''-'')'
$customps1_injection_lines +=''
$customps1_injection_lines +='    $bytes = New-Object ''Byte[]'' 16'
$customps1_injection_lines +='    [Buffer]::BlockCopy($array, 0, $bytes, 0, 16)'
$customps1_injection_lines +='    [Guid]$guid = $bytes'
$customps1_injection_lines +=''
$customps1_injection_lines +='    return $guid'
$customps1_injection_lines +='}'
$customps1_injection_lines +='Function GetLocalAdmins ($AdminsToRemove, $AdminsToAllow)'
$customps1_injection_lines +='{'
$customps1_injection_lines +='    # Get Admins to remove and allow as arrays'
$customps1_injection_lines +='    $AdminsToRemoveArray = @()'
$customps1_injection_lines +='    $AdminsToAllowArray = @()'
$customps1_injection_lines +='    ForEach ($AllowRemove in "Allow","Remove")'
$customps1_injection_lines +='    { # each Allow and Remove'
$customps1_injection_lines +='        # Split comma string into array'
$customps1_injection_lines +='        if ($AllowRemove -eq "Allow") {'
$customps1_injection_lines +='            $AdminElems = $AdminsToAllow.Split(",")'
$customps1_injection_lines +='        }'
$customps1_injection_lines +='        if ($AllowRemove -eq "Remove") {'
$customps1_injection_lines +='            $AdminElems = $AdminsToRemove.Split(",")'
$customps1_injection_lines +='        }'
$customps1_injection_lines +='        # Process each admin element'
$customps1_injection_lines +='        ForEach ($AdminElem in $AdminElems)'
$customps1_injection_lines +='        { # each admin element'
$customps1_injection_lines +='            $AdminElem = $AdminElem.Trim()'
$customps1_injection_lines +='            if ($AdminElem -eq "") {Continue}'
$customps1_injection_lines +='            $AdminSrch = $AdminElem.Replace("*","")'
$customps1_injection_lines +='            $AdminSrch = $AdminSrch.Replace(".\","$($env:COMPUTERNAME)\")'
$customps1_injection_lines +='            if ($AdminSrch  -notlike "*\*" ) {$AdminSrch = "$($env:COMPUTERNAME)\$($AdminElem)"}'
$customps1_injection_lines +='            # Create object'
$customps1_injection_lines +='            $obj_this = [PSCustomObject]@{'
$customps1_injection_lines +='                Elem = $AdminElem'
$customps1_injection_lines +='                Srch = $AdminSrch'
$customps1_injection_lines +='                Type = $AllowRemove'
$customps1_injection_lines +='            } # create object'
$customps1_injection_lines +='            # Add to correct array'
$customps1_injection_lines +='            if ($AllowRemove -eq "Allow") {'
$customps1_injection_lines +='                $AdminsToAllowArray += $obj_this'
$customps1_injection_lines +='            }'
$customps1_injection_lines +='            if ($AllowRemove -eq "Remove") {'
$customps1_injection_lines +='                $AdminsToRemoveArray += $obj_this'
$customps1_injection_lines +='            }'
$customps1_injection_lines +='        } # each admin element'
$customps1_injection_lines +='    } # each Allow and Remove'
$customps1_injection_lines +='    # Get local admins'
$customps1_injection_lines +='    $LocalUsers = Get-LocalGroupMember -SID "S-1-5-32-544"'
$customps1_injection_lines +='    $locadmins = @()'
$customps1_injection_lines +='    ForEach ($LocalUser in $LocalUsers)'
$customps1_injection_lines +='    {'
$customps1_injection_lines +='        # Create custom object and append to array'
$customps1_injection_lines +='        $user_this = [PSCustomObject]@{'
$customps1_injection_lines +='            Name = $LocalUser.Name'
$customps1_injection_lines +='            NameClean = $LocalUser.Name'
$customps1_injection_lines +='            NameOrig = $LocalUser.Name'
$customps1_injection_lines +='            SID  = $LocalUser.SID.value'
$customps1_injection_lines +='            Class = $LocalUser.ObjectClass'
$customps1_injection_lines +='            Source = $LocalUser.PrincipalSource'
$customps1_injection_lines +='            Enabled = $true'
$customps1_injection_lines +='            Status = ""'
$customps1_injection_lines +='        } # create object'
$customps1_injection_lines +='        # Adjust Name for AzureAD accounts'
$customps1_injection_lines +='        if ($user_this.SID.StartsWith("S-1-12-1-"))'
$customps1_injection_lines +='        {'
$customps1_injection_lines +='            $user_this.Name = "AzureAD ObjectID " + (Convert-AzureAdSidToObjectId -Sid $user_this.SID)'
$customps1_injection_lines +='        }'
$customps1_injection_lines +='        # Check if enabled'
$customps1_injection_lines +='        if ($user_this.Class -eq "User") {'
$customps1_injection_lines +='            $locuser = Get-LocalUser -SID $user_this.SID -ErrorAction SilentlyContinue'
$customps1_injection_lines +='            if ($locuser) {'
$customps1_injection_lines +='                $user_this.Enabled = $locuser.Enabled'
$customps1_injection_lines +='            } # is found'
$customps1_injection_lines +='        } # is User'
$customps1_injection_lines +='        # Name fixes'
$customps1_injection_lines +='        if ($user_this.NameClean -eq $user_this.SID) {'
$customps1_injection_lines +='            $user_this.NameClean = $user_this.Name'
$customps1_injection_lines +='        }'
$customps1_injection_lines +='        if ($user_this.Source -notin "Local","AzureAD") {'
$customps1_injection_lines +='            $user_this.Status = "OK: Account source is ignored by this script [$($user_this.Source)]"'
$customps1_injection_lines +='        } # account source ignored'
$customps1_injection_lines +='        else'
$customps1_injection_lines +='        { # account source not ignored'
$customps1_injection_lines +='            # ToRemove'
$customps1_injection_lines +='            $toRemove = $false'
$customps1_injection_lines +='            $RemoveVia = ""'
$customps1_injection_lines +='            ForEach ($AdminToRemove in $AdminsToRemoveArray) {'
$customps1_injection_lines +='                if ($user_this.NameClean -like "*$($AdminToRemove.Srch)*" ) {'
$customps1_injection_lines +='                    $toRemove = $true; $RemoveVia=$AdminToRemove.Elem ;break'
$customps1_injection_lines +='                }'
$customps1_injection_lines +='            }'
$customps1_injection_lines +='            # ToAllow'
$customps1_injection_lines +='            $toAllow = $false'
$customps1_injection_lines +='            $AllowVia = ""'
$customps1_injection_lines +='            ForEach ($AdminToAllow in $AdminsToAllowArray) {'
$customps1_injection_lines +='                if ($user_this.NameClean -like "*$($AdminToAllow.Srch)*" ) {'
$customps1_injection_lines +='                    $toAllow = $true; $AllowVia=$AdminToAllow.Elem ;break'
$customps1_injection_lines +='                }'
$customps1_injection_lines +='            }'
$customps1_injection_lines +='            if ($toAllow)'
$customps1_injection_lines +='            { # marked to allow'
$customps1_injection_lines +='                if ($toRemove) {'
$customps1_injection_lines +='                    if ($user_this.Enabled) {'
$customps1_injection_lines +='                        $user_this.Status = "OK: Allowed (overrides removal) [AllowVia $($AllowVia), RemoveVia $($RemoveVia)]"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                    else {'
$customps1_injection_lines +='                        $user_this.Status = "OK: Allowed (overrides removal), but account is disabled [AllowVia $($AllowVia), RemoveVia $($RemoveVia)]"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                } # allowed and marked to remove'
$customps1_injection_lines +='                else {'
$customps1_injection_lines +='                    if ($user_this.Enabled) {'
$customps1_injection_lines +='                        $user_this.Status = "OK: Allowed [AllowVia $($AllowVia)]"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                    else {'
$customps1_injection_lines +='                        $user_this.Status = "OK: Allowed, but account is disabled [AllowVia $($AllowVia)]"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                } # allowed and not marked to remove'
$customps1_injection_lines +='            } # marked to allow'
$customps1_injection_lines +='            else'
$customps1_injection_lines +='            { # not marked to allow'
$customps1_injection_lines +='                if ($toRemove) {'
$customps1_injection_lines +='                    if ($user_this.Enabled) {'
$customps1_injection_lines +='                        $user_this.Status = "Action: Needs removal (will be de-elevated) [RemoveVia $($RemoveVia)]"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                    else {'
$customps1_injection_lines +='                        $user_this.Status = "OK: Marked for removal (but is disabled so no action needed) [RemoveVia $($RemoveVia)]"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                } # marked to remove'
$customps1_injection_lines +='                else {'
$customps1_injection_lines +='                    if ($user_this.Enabled) {'
$customps1_injection_lines +='                        $user_this.Status = "OK: Not marked for removal"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                    else {'
$customps1_injection_lines +='                        $user_this.Status = "OK: Not marked for removal (and is disabled already)"'
$customps1_injection_lines +='                    }'
$customps1_injection_lines +='                } # not marked to remove'
$customps1_injection_lines +='            } # not marked to allow'
$customps1_injection_lines +='            '
$customps1_injection_lines +='        } # account source not ignored'
$customps1_injection_lines +='        # Append to array'
$customps1_injection_lines +='        $locadmins += $user_this'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='    return $locadmins'
$customps1_injection_lines +='} # GetLocalAdmins'
$customps1_injection_lines +='$app_detected = $false'
$customps1_injection_lines +='WriteLog "------ intune_settings.csv"'
$customps1_injection_lines +='WriteLog "AppVar1 is $($IntuneApp.AppVar1)" # AdminsToRemove'
...
$customps1_injection_lines +='$AdminsToRemove = $Contents'
$customps1_injection_lines +=''
$customps1_injection_lines +='WriteLog "AppVar2 is $($IntuneApp.AppVar2)" # AdminsToAllow'
$customps1_injection_lines +='if ($IntuneApp.AppVar1 -match ":") {'
$customps1_injection_lines +='    $Contents = ($IntuneApp.AppVar2 -split ":")[1].trim(" ") # grab the stuff after the :'
$customps1_injection_lines +='} # there''s a : char'
$customps1_injection_lines +='$AdminsToAllow = $Contents'
$customps1_injection_lines +='WriteLog "Admins To Remove: " -NoNewline'
$customps1_injection_lines +='WriteLog $AdminsToRemove -ForegroundColor cyan'
$customps1_injection_lines +='WriteLog "Admins To Allow : " -NoNewline'
$customps1_injection_lines +='WriteLog $AdminsToAllow -ForegroundColor cyan'
$customps1_injection_lines +='if ($true) {'
$customps1_injection_lines +='    WriteLog "-----------------------------------------------------"'
$customps1_injection_lines +='    WriteLog "Local Admin Accounts on this machine"'
$customps1_injection_lines +='    WriteLog "-----------------------------------------------------"'
$customps1_injection_lines +='    $NoneToRemove = $true'
$customps1_injection_lines +='    $LocalAdmins = GetLocalAdmins -AdminsToRemove $AdminsToRemove -AdminsToAllow $AdminsToAllow'
$customps1_injection_lines +='    if ($LocalAdmins.count -eq 0) {'
$customps1_injection_lines +='        WriteLog "No local admins" -ForegroundColor Yellow'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='    else'
$customps1_injection_lines +='    { # LocalAdmins found'
$customps1_injection_lines +='        ForEach ($LocalAdmin in $LocalAdmins | Sort-Object Source,NameClean)'
$customps1_injection_lines +='        { # each local admin'
$customps1_injection_lines +='            WriteLog "[$($LocalAdmin.Source)] $($LocalAdmin.NameClean) " -NoNewline'
$customps1_injection_lines +='            if ($LocalAdmin.Status -like "Action:*") {'
$customps1_injection_lines +='                if ($NoneToRemove) {$NoneToRemove = $false}'
$customps1_injection_lines +='                WriteLog $LocalAdmin.Status -ForegroundColor yellow'
$customps1_injection_lines +='            } # action required'
$customps1_injection_lines +='            else {'
$customps1_injection_lines +='                WriteLog $LocalAdmin.Status -ForegroundColor Green'
$customps1_injection_lines +='            } # no action'
$customps1_injection_lines +='        } # each local admin'
$customps1_injection_lines +='    }  # LocalAdmins found'
$customps1_injection_lines +='    WriteLog "-----------------------------------------------------"'
$customps1_injection_lines +='    if ($NoneToRemove) {'
$customps1_injection_lines +='        # $strReturn = "OK: $($scriptName) $($CmdLineInfo) [No local admins found to remove]"'
$customps1_injection_lines +='        # $exitcode = 0'
$customps1_injection_lines +='        $app_detected = $true'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='    else {'
$customps1_injection_lines +='        # $strReturn = "ERR: $($scriptName) $($CmdLineInfo) [Local admin found to remove]"'
$customps1_injection_lines +='        # $exitcode = 99'
$customps1_injection_lines +='        $app_detected = $false'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='    WriteLog "Check: $($strReturn)"'
$customps1_injection_lines +='    # if ($mode -eq '''') {PressEnterToContinue}'
$customps1_injection_lines +='}'
$customps1_injection_lines +='WriteLog "-----------------------------------------------------------------------------"'
$customps1_injection_lines +='WriteLog "App detected (No Removal needed): $($app_detected)"'
