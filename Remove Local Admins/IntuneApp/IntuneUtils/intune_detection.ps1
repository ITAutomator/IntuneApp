...
$customps1_injection_lines +='    ForEach ($AdminObj in $AdminsToRemove.Split(",") ) {'
$customps1_injection_lines +='        $AdminObj = $AdminObj.Trim()'
$customps1_injection_lines +='        if ($AdminObj -eq "") {Continue}'
$customps1_injection_lines +='        $AdminObj = $AdminObj.Replace("*","")'
$customps1_injection_lines +='        $AdminObj = $AdminObj.Replace(".\","$($env:COMPUTERNAME)\")'
$customps1_injection_lines +='        if ($AdminObj  -notlike "*\*" ) {$AdminObj = "$($env:COMPUTERNAME)\$($AdminObj)"}'
$customps1_injection_lines +='        $AdminsToRemoveArray += $AdminObj'
$customps1_injection_lines +='    }'
$customps1_injection_lines +='    ForEach ($AdminObj in $AdminsToAllow.Split(",")) {'
$customps1_injection_lines +='        $AdminObj = $AdminObj.Trim()'
$customps1_injection_lines +='        if ($AdminObj -eq "") {Continue}'
$customps1_injection_lines +='        $AdminObj = $AdminObj.Replace("*","")'
$customps1_injection_lines +='        $AdminObj = $AdminObj.Replace(".\","$($env:COMPUTERNAME)\")'
$customps1_injection_lines +='        if ($AdminObj  -notlike "*\*" ) {$AdminObj = "$($env:COMPUTERNAME)\$($AdminObj)"}'
$customps1_injection_lines +='        $AdminsToAllowArray += $AdminObj'
$customps1_injection_lines +='    }'
...
$customps1_injection_lines +='            #IsAdmin = $false'
...
$customps1_injection_lines +='        # Replace computername prefix with .'
$customps1_injection_lines +='        # $user_this.NameClean = $user_this.NameClean.Replace("$($env:COMPUTERNAME)\",".\")'
...
$customps1_injection_lines +='                if ($user_this.NameClean -like "*$($AdminToRemove)*" ) {'
$customps1_injection_lines +='                    $toRemove = $true; $RemoveVia=$AdminToRemove ;break'
$customps1_injection_lines +='                }'
$customps1_injection_lines +='            }'
...
$customps1_injection_lines +='                if ($user_this.NameClean -like "*$($AdminToAllow)*" ) {'
$customps1_injection_lines +='                    $toAllow = $true; $AllowVia=$AdminToAllow ;break'
$customps1_injection_lines +='                }'
$customps1_injection_lines +='            }'
