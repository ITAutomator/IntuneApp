...
Function IntuneAppValues
{
	...
	$IntuneAppValues = @{}
    $IntuneAppValues.Add("AppName","Advanced IP Scanner-v174")
    ...
    $IntuneAppValues.Add("AppUninstallVersion","2.5")
    $IntuneAppValues.Add("AppUninstallProcess","advanced_ip_scanner")
